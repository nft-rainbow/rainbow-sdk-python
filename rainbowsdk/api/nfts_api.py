...
class NFTsApi(object):
    ...
    def nft_info(self, authorization, address, token_id, **kwargs):  # noqa: E501
        ...
        :type address: str
        :param token_id: token_id (required)
        :type token_id: str
    ...
    def nft_info_with_http_info(self, authorization, address, token_id, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ServicesNFT, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def update_nft_token_uri(self, authorization, address, token_id, chain, **kwargs):  # noqa: E501
        """Update NFT token uri  # noqa: E501

        Update NFT token uri  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_nft_token_uri(authorization, address, token_id, chain, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ModelsTransaction
        """
        kwargs['_return_http_data_only'] = True
        return self.update_nft_token_uri_with_http_info(authorization, address, token_id, chain, **kwargs)  # noqa: E501

    def update_nft_token_uri_with_http_info(self, authorization, address, token_id, chain, **kwargs):  # noqa: E501
        """Update NFT token uri  # noqa: E501
        ...
        >>> thread = api.update_nft_token_uri_with_http_info(authorization, address, token_id, chain, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ModelsTransaction, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_nft_token_uri" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and local_var_params.get('authorization') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `authorization` when calling `update_nft_token_uri`")  # noqa: E501
        # verify the required parameter 'address' is set
        if self.api_client.client_side_validation and local_var_params.get('address') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `address` when calling `update_nft_token_uri`")  # noqa: E501
        # verify the required parameter 'token_id' is set
        if self.api_client.client_side_validation and local_var_params.get('token_id') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `token_id` when calling `update_nft_token_uri`")  # noqa: E501
        # verify the required parameter 'chain' is set
        if self.api_client.client_side_validation and local_var_params.get('chain') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `chain` when calling `update_nft_token_uri`")  # noqa: E501
        ...
        if 'chain' in local_var_params:
            body_params = local_var_params['chain']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        response_types_map = {
            200: "ModelsTransaction",
            400: "RainbowErrorsRainbowErrorDetailInfo",
        }

        return self.api_client.call_api(
            '/nft/{address}/{token_id}/tokenUri', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
